...
# ---[ OpenCV
if(USE_OPENCV)
  find_package(OpenCV QUIET COMPONENTS core highgui imgproc imgcodecs videoio cudaarithm cudawarping cudaimgproc)
...
if(NCCL_FOUND)
  ...
  include_directories(SYSTEM ${NCCL_INCLUDE} ${NCCL_INCLUDE_DIR})
