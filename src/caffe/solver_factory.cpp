...
template<typename T> typename SolverRegistry<T>::CreatorRegistry& SolverRegistry<T>::Registry()
{
...
template<typename Dtype> Solver<Dtype>* SolverRegistry<Dtype>::CreateSolver(const SolverParameter& param, Solver<Dtype>* root_solver) {
