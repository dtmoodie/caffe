...
CAFFE_EXPORT void caffe_cpu_gemm(const CBLAS_TRANSPOSE TransA,
...
template <typename Dtype>
CAFFE_EXPORT void caffe_axpy(const int N, const Dtype alpha, const Dtype* X,
    Dtype* Y);
...
template <typename Dtype>
CAFFE_EXPORT void caffe_copy(const int N, const Dtype *X, Dtype *Y);

template <typename Dtype>
CAFFE_EXPORT void caffe_set(const int N, const Dtype alpha, Dtype *X);
...
template <typename Dtype>
CAFFE_EXPORT void caffe_add_scalar(const int N, const Dtype alpha, Dtype *X);

template <typename Dtype>
CAFFE_EXPORT void caffe_scal(const int N, const Dtype alpha, Dtype *X);
...
template <typename Dtype>
CAFFE_EXPORT Dtype caffe_cpu_asum(const int n, const Dtype* x);
...
template <typename Dtype>
CAFFE_EXPORT void caffe_gpu_gemm(const CBLAS_TRANSPOSE TransA,
    const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
    const Dtype alpha, const Dtype* A, const Dtype* B, const Dtype beta,
    Dtype* C);
...
template <typename Dtype>
CAFFE_EXPORT void caffe_gpu_set(const int N, const Dtype alpha, Dtype *X);
...
template <typename Dtype>
CAFFE_EXPORT void caffe_gpu_exp(const int n, const Dtype* a, Dtype* y);
...
// [0, UINT_MAX].
CAFFE_EXPORT void caffe_gpu_rng_uniform(const int n, unsigned int* r);
...
template<typename Dtype>
CAFFE_EXPORT void caffe_gpu_sign(const int n, const Dtype* x, Dtype* y);

template<typename Dtype>
CAFFE_EXPORT void caffe_gpu_sgnbit(const int n, const Dtype* x, Dtype* y);
