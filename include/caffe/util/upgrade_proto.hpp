...
CAFFE_EXPORT bool UpgradeNetAsNeeded(const string& param_file,
    NetParameter* param);
...
CAFFE_EXPORT bool UpgradeV0Net(const NetParameter& v0_net_param,
...
CAFFE_EXPORT bool UpgradeV0LayerParameter(
...
CAFFE_EXPORT bool UpgradeV1Net(const NetParameter& v1_net_param,
    NetParameter* net_param);

CAFFE_EXPORT bool UpgradeV1LayerParameter(
    const V1LayerParameter& v1_layer_param, LayerParameter* layer_param);

CAFFE_EXPORT const char* UpgradeV1LayerType(
...
CAFFE_EXPORT bool UpgradeSolverAsNeeded(const string& param_file,
