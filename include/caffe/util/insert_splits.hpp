...
CAFFE_EXPORT void InsertSplits(
    const NetParameter& param, NetParameter* param_split);

CAFFE_EXPORT void ConfigureSplitLayer(const string& layer_name,
    const string& blob_name,
    const int blob_idx, const int split_count, const float loss_weight,
    LayerParameter* split_layer_param);

CAFFE_EXPORT string SplitLayerName(const string& layer_name,
    const string& blob_name,
    const int blob_idx);

CAFFE_EXPORT string SplitBlobName(const string& layer_name,
    const string& blob_name,
