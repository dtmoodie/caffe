...
CAFFE_EXPORT void GetImageSize(const string& filename, int* height, int* width);

CAFFE_EXPORT bool ReadRichImageToAnnotatedDatum(const string& filename,
...
CAFFE_EXPORT bool ReadXMLToAnnotatedDatum(const string& labelname, const int img_height,
    const int img_width, const std::map<string, int>& name_to_label,
    AnnotatedDatum* anno_datum);

CAFFE_EXPORT bool ReadJSONToAnnotatedDatum(const string& labelname, const int img_height,
    const int img_width, const std::map<string, int>& name_to_label,
    AnnotatedDatum* anno_datum);

CAFFE_EXPORT bool ReadTxtToAnnotatedDatum(const string& labelname, const int height,
    const int width, AnnotatedDatum* anno_datum);

CAFFE_EXPORT bool ReadLabelFileToLabelMap(const string& filename, bool include_background,
...
CAFFE_EXPORT bool MapNameToLabel(const LabelMap& map, const bool strict_check,
...
CAFFE_EXPORT bool MapLabelToName(const LabelMap& map, const bool strict_check,
...
CAFFE_EXPORT bool MapLabelToDisplayName(const LabelMap& map, const bool strict_check,
...
#ifdef USE_OPENCV
CAFFE_EXPORT cv::Mat ReadImageToCVMat(const string& filename, const int height,
